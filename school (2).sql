...
(1, '17 Smith', '2022-02-23 10:19:21'),
(4, '29 Adams', '2022-02-23 10:19:21'),
(5, '37 Williams', '2022-02-23 10:19:22'),
(18, '143 Smith', '2022-02-23 10:19:22'),
(25, '57 Adams', '2022-02-23 10:19:22'),
(27, '271 Williams', '2022-02-23 10:19:22'),
(31, '131 Smith', '2022-02-23 10:19:22'),
(34, '213 Smith', '2022-02-23 10:19:22');
...
(21, 'Holt1', 'Roger', '2024-03-19 00:00:00', '2004-09-01 00:00:00'),
...
--
ALTER TABLE `course`
  ADD CONSTRAINT `course_1` FOREIGN KEY (`DepartmentID`) REFERENCES `department` (`DepartmentID`);

--
-- Các ràng buộc cho bảng `courseinstructor`
--
ALTER TABLE `courseinstructor`
  ADD CONSTRAINT `CourseInstructor_1` FOREIGN KEY (`CourseID`) REFERENCES `course` (`CourseID`),
  ADD CONSTRAINT `CourseInstructor_2` FOREIGN KEY (`PersonID`) REFERENCES `person` (`PersonID`);

--
-- Các ràng buộc cho bảng `officeassignment`
--
ALTER TABLE `officeassignment`
  ADD CONSTRAINT `OfficeAssignment_1` FOREIGN KEY (`InstructorID`) REFERENCES `person` (`PersonID`);
...
--
ALTER TABLE `studentgrade`
  ADD CONSTRAINT `StudentGrade_1` FOREIGN KEY (`CourseID`) REFERENCES `course` (`CourseID`),
  ADD CONSTRAINT `StudentGrade_2` FOREIGN KEY (`StudentID`) REFERENCES `person` (`PersonID`);
COMMIT;
